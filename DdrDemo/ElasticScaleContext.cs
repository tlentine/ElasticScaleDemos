...
namespace DdrDemo {
    public class ElasticScaleContext<T> :DbContext {
        ...
        public ElasticScaleContext(ShardMap shardMap, T shardingKey, string shardMapManagerConnString)
            : base(CreateDDRConnection(shardMap, shardingKey, shardMapManagerConnString), true /* contextOwnsConnection */) {
        }
